...
public class ConfigScreenBuilder {
    ...
    public static Screen buildScreen(Screen parent) {
        ...
        general.addEntry(entry.startIntSlider(Component.translatable("config.deadsun.maxZombiesOverworld"), config.getMaxZombiesOverworld(), 10, 200)
        ...
        general.addEntry(entry.startIntSlider(Component.translatable("config.deadsun.maxZombiesEnd"), config.getMaxZombiesEnd(), 10, 300)
        ...
        general.addEntry(entry.startIntSlider(Component.translatable("config.deadsun.maxZombiesNether"), config.getMaxZombiesNether(), 10, 200)
        ...
        general.addEntry(entry.startBooleanToggle(Component.translatable("config.deadsun.groupSpawning"), config.isGroupSpawning())
        ...
        general.addEntry(entry.startIntSlider(Component.translatable("config.deadsun.minGroupSize"), config.getMinGroupSize(), 2, 6)
        ...
        general.addEntry(entry.startIntSlider(Component.translatable("config.deadsun.maxGroupSize"), config.getMaxGroupSize(), 4, 16)
